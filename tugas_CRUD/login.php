...
<div class="container mt-5">
    <div class="row">
        ...
        <p class="a"><b>Akun Anda Belum Terdaftar</b><a href="register.php">Silahkan Klik di sini</a>Silahkan Coba Lagi</p>
        <form action="connect_login.php" method="POST">
            ...
            <input type="text" id="username" name="email" placeholder="Username atau email" ><br>
